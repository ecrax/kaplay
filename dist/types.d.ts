...
export declare class Color {
	 ...
	 */
	static fromCSS(cssColor: CSSColor): Color;
	static RED: Color;
	static GREEN: Color;
	static BLUE: Color;
	static YELLOW: Color;
...
declare const createFrameRenderer: (gfx: AppGfxCtx, game: Game, pixelDensity: number) => {
	frameStart: () => void;
	frameEnd: () => void;
